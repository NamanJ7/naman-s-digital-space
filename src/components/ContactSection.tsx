...
const ContactSection = () => {
  ...
  return <section className="w-full py-16 md:py-24 px-6 md:px-12 lg:px-24">
      <div className="max-w-6xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 md:gap-16">
          ...
          <div>
            ...
            <p className="text-muted-foreground mb-8">Don't be a random, message me!</p>

            <div className="space-y-6">
              {contactInfo.map(item => <a key={item.label} href={item.href} target={item.href.startsWith("mailto") ? undefined : "_blank"} rel="noopener noreferrer" className="flex items-center gap-4 group">
